...
import { fetchFollowing, fetchOneUserProfile, userDataToProfile } from '../../../api/user'
                ...
                <Card>
                    <div className="relative">
                        ...
                        <div className="ml-40">
                            ...
                            <div className="text-heavy-metal-500 leading-4">{userData?.place},{userData?.country}</div>
                        </div>
                    </div>
